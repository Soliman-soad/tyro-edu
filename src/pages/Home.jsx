...
<section className='light:bg-slate-800 py-5 dark:bg-white dark:text-gray-900'>
  ...
  <div className="card-body">
    ...
    <div className="card-actions justify-end">
      <button className="btn bg-teal-700 text-white border-0 w-full"><Link to='courses'>Enroll now</Link></button>
    </div>
  </div>
					</div>
					</div>
...
<section className="p-6 dark:bg-gray-800 dark:text-gray-100 py-8 bg-white text-gray-900">
	...
	<div className="container flex flex-wrap justify-center mx-auto text-teal-700">
