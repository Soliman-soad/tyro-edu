    ...
    return (
        <div>
            <div className=' dark:text-white text-gray-800  my-5'>
                <h1 className=' dark:text-white text-4xl font-bold uppercase'> what is cors?</h1>
            ...
            <div className=' dark:text-white text-gray-800  my-5'>
                <h1 className=' dark:text-white text-3xl font-bold uppercase'>Why are you using firebase? What other options do you have to implement authentication?</h1>
                <p>Firebase Authentication provides backend services, easy-to-use SDKs, and ready-made UI libraries to authenticate users to your app. It supports authentication using passwords, phone numbers, popular federated identity providers like Google, Facebook and Twitter, and more.</p>
            </div>
            <div className=' dark:text-white text-gray-800  my-5'>
                <h1 className=' dark:text-white text-3xl font-bold uppercase'>How does the private route work?</h1>
            ...
            <div className=' dark:text-white text-gray-800  my-5'>
                <h1 className=' dark:text-white text-3xl font-bold uppercase'>What is Node? How does Node work?</h1>
