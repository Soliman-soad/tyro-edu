...
const Register = () => {
    ...
    <form  className="space-y-8 ">
		<div className="space-y-4">
			...
			<div className="space-y-2">
				<label htmlFor="img" className="block text-sm">Email address</label>
			...
			<div className="space-y-2">
				...
				<input type="password" name="password" id="password" placeholder="Enter a password" className="w-full px-3 py-2 border rounded-md dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 focus:dark:border-violet-400" />
			</div>
		</div>
