...
const Register = () => {
  ...
  const from = location.state?.from?.pathname || '/';
    ...
    return (
        <div>
            <div className="w-full max-w-md p-4 mt-5 mx-auto rounded-md shadow sm:p-8 dark:bg-gray-900 dark:text-gray-100 bg-white text-gray-900">
    ...
    <div className="my-6 space-y-4">
		<button onClick={handleGoogleLogIn} aria-label="Login with Google" type="button" className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 text-white bg-red-500 focus:ring-offset-1 dark:border-gray-400 focus:ring-violet-400">
