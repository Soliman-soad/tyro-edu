...
const Data = () => {
    ...
    const courses = coursesData.filter(data => data.category ==='Data')
    return (
        <div>
             <div>
			...
			courses.map(course => {
				return (
					...
					<div key={course.id} className='dark:text-white text-gray-900'>
						<div  className="card border-teal-400 border-2 w-80 h-full bg-white dark:bg-white dark:bg-base-100 shadow-xl">
